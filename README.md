matrixv2.py is the only working one, the other one, matrix.py was included just bc i thought "why not?". maybe it's a bit interesting I took two different approaches ig. 
